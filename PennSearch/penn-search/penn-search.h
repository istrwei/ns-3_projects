...
class PennSearch : public PennApplication
{
  public:
    ...
    void SendPennSearchPing (uint32_t nodeNumber, std::string pingMessage);
    ...
    // Chord Callbacks
    void HandleChordPingSuccess (std::string nodeId, std::string message);
    void HandleChordPingFailure (std::string nodeId, std::string message);
    void HandleChordPingRecv (std::string nodeId, std::string message);
